...
class App(tk.Tk):
    ...
    def _make_slot_row(self, parent, k, is_equip):
        ...
        ttk.Label(r, text="修饰", width=5).pack(side="left")
    ...
    def _set_slot_widget(self, w, item_id, mod):
        ...
        w["dec"].config(text="(类型=%d, 数量=%d)" % (mod & 0xFF, (mod >> 8) & 0xFFFFFF))
    ...
    def apply_slot(self, k, is_equip, item_id=None, modifier=None):
        ...
        w["dec"].config(text="(类型=%d, 数量=%d)" % (cur_mod & 0xFF, (cur_mod >> 8) & 0xFFFFFF))
